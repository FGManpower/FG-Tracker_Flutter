...
class PrivacyTermsBottomSheet extends StatefulWidget {
  ...
  @override
  _PrivacyTermsBottomSheetState createState() =>
      _PrivacyTermsBottomSheetState();
}
...
class _PrivacyTermsBottomSheetState extends State<PrivacyTermsBottomSheet> {
  ...
  void _handleAccept() async {
    await Global.storageServices
        .setString("${PrefConst.AcceptPolicy}_${widget.userPhone}", "true");
  ...
  void _handleDecline() {
    Global.storageServices
        .setString("${PrefConst.AcceptPolicy}_${widget.userPhone}", "false");
      ...
      child: DraggableScrollableSheet(
        ...
        builder: (_, sheetController) => Padding(
          ...
          child: Container(
            ...
            child: Column(
              mainAxisAlignment:
                  MainAxisAlignment.spaceBetween, // ✅ Keeps buttons visible
              children: [
                ...
                Expanded(
                  child: Scrollbar(
                    ...
                    child: Obx(
                        () => _buildContent(termsController.showTerms.value)),
                  ),
                ),
                _scrollToBottomButton(),
                SafeArea(
                  // ✅ Ensures buttons are not hidden behind keyboard or notch
  ...
  Widget _buildHeader(bool showTerms) => Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 10),
            reausabletext(showTerms ? "Terms & Conditions" : "Privacy Policy",
  ...
  Widget _buildContent(bool showTerms) {
    final String content =
        showTerms ? PolicyTexts.termsAndConditions : PolicyTexts.privacyPolicy;
  ...
  Widget _buildBottomButtons(bool isAtBottom, bool showTerms) {
    if (!isAtBottom) {
      return SizedBox(
        height: 40,
        child: Center(
            child: reausabletext("Scroll to the bottom to proceed",
